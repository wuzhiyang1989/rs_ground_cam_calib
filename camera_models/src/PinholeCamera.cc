                                  ...
                                  const std::vector< std::vector<cv::Point2f> >& imagePoints)
{
    ...
    for (size_t i = 0; i < nImages; ++i)
    {
        ...
        //printf("call cv::findHomography() begin [PinholeCamera::%s, %d]\n", __func__, __LINE__);
        cv::Mat H = cv::findHomography(M, imagePoints.at(i));
        //printf("call cv::findHomography() end [PinholeCamera::%s, %d]\n", __func__, __LINE__);
    ...
    std::cout << "params = " << params << std::endl;    // note the reload operation of "<<"
...
PinholeCamera::liftProjective(const Eigen::Vector2d& p, Eigen::Vector3d& P) const
{
    ...
    //printf("PinholeCamera::%s, %d\n", __func__, __LINE__);

    // printf("k1=%f, k2=%f, p1=%f, p2=%f, fx=%f, fy=%f, cx=%f, cy=%f\n", mParameters.k1(), mParameters.k2(), mParameters.p1() ,mParameters.p2(), mParameters.fx(), mParameters.fy(), mParameters.cx(), mParameters.cy());
...
void
PinholeCamera::initUndistortMap(cv::Mat& map1, cv::Mat& map2,
...
PinholeCamera::readParameters(const std::vector<double>& parameterVec)
{
    ...
    //std::cout << "PinholeCamera::readParameters: " << "params = " << params << std::endl;
...
PinholeCamera::writeParameters(std::vector<double>& parameterVec) const
{
    ...
    //std::cout << "PinholeCamera::writeParameters: " << "mParameters = " << mParameters << std::endl;
}

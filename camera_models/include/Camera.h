...
public:
    ...
    virtual void initUndistortMap(cv::Mat& map1, cv::Mat& map2,
                                  Eigen::Matrix3d &cameramatrix_intput,
                                  Eigen::Matrix3d &cameramatrix_output,
                                  double &empty_pixels,
                                  double fScale = 1.0) const = 0;
    ...
    virtual void undistortImage(const cv::Mat& image,
                                cv::Mat &undistorted_image,
                                const cv::Mat &map_x,
                                const cv::Mat &map_y,
                                double empty_pixels) const;

    virtual bool pixel_distortion(Eigen::Matrix3d &cameramatrix_dist,
